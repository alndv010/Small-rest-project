 ...
 */
public class TransactionInfoRepository extends DAOImpl<TransactionInfoRecord, TransactionInfoData, String> {

    private final DSLContext context;

    @Inject
    public TransactionInfoRepository(DSLContext dsl, Configuration configuration) {
